...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-911-erd-s-problem-911-d88d3863-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-911"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-911-erd-s-problem-911-d88d3863-v1",
      "problem_contract_sha256": "f48c248c4d31a0866ccb023c4291bc8fd00591f3298dfe17c2877538d818b2ec",
      "problem_id": "problem:um-ep-911-erd-s-problem-911-d88d3863",
      "route_id": "route:um-ep-911-erd-s-problem-911-d88d3863-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-911-erd-s-problem-911-d88d3863-source-fidelity-01",
      "graph_id": "graph:um-ep-911-erd-s-problem-911-d88d3863-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-911-erd-s-problem-911-d88d3863-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-911-erd-s-problem-911-d88d3863-root",
          "statement": {
          ...
          "statement_sha256": "34dc53d056932a3316aa22fe5cba714df95bc9b805a49d5fbd2654b137e43978"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-911-erd-s-problem-911-d88d3863-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-911-erd-s-problem-911-d88d3863-root",
      "route_id": "route:um-ep-911-erd-s-problem-911-d88d3863-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-911-0f77a6983470",
        "url": "https://www.unsolvedmath.com/problems/EP-911"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
